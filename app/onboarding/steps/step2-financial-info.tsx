          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full bg-surface-container-high border border-outline-variant rounded-lg pl-8 pr-4 py-4 focus:border-secondary focus:ring-0 focus:outline-none transition-all font-numeric-data text-numeric-data text-on-surface neon-glow-indigo"
              />
            </div>
          </div>
          <div className="space-y-2">
                ...
                <div className="space-y-2 pt-4 border-t border-white/5">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-surface-container border border-outline-variant rounded-lg pl-6 pr-3 py-2 focus:border-secondary focus:ring-0 text-sm font-numeric-data text-on-surface transition-all"
                    />
                  </div>
                </div>
              )}
